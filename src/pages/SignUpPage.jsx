  ...
  if (authType !== 'clerk') {
    return (
      <div className="page-enter mx-auto max-w-md px-4 py-16 text-center">
        ...
        <h1 className="mt-4 text-3xl font-extrabold text-ink">Create an account</h1>
        <p className="mt-2 text-ink-soft">
          Accounts are powered by Clerk and aren't connected yet.
        </p>
  ...
  return (
    <div className="page-enter mx-auto max-w-md px-4 py-16">
      <div className="text-center">
        <img src="/homeserve-logo.png" alt="HomeServe" className="mx-auto h-14 w-auto" />
        <h1 className="mt-4 text-3xl font-extrabold text-ink">Create your account</h1>
        <p className="mt-2 text-ink-soft">Join HomeServe to book pros and save favorites.</p>
      </div>

      <div className="mt-8 rounded-3xl border border-gray-200/70 bg-white p-7 shadow-xl shadow-primary/5">
        <SignUp fallbackRedirectUrl={from} signInUrl={`/sign-in?redirect=${encodeURIComponent(from)}`} />
      </div>
    </div>
  )
}
